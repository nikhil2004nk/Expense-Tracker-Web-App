...
export default function Budgets() {
  ...
  // Get user's preferred currency from Profile settings
  ...
  const handleDeleteBudget = (budget) => {
    ...
    if (confirmed) {
      setBudgetData(prev => prev.filter(b => b.id !== budget.id))
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      {budgetData.length === 0 ? (
        <div className="text-center py-10 sm:py-12 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm px-4">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-5 sm:mb-6 max-w-sm mx-auto">
          ...
          return (
            <div key={budget.id} className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 sm:p-5 md:p-6 shadow-sm hover:shadow-lg dark:hover:shadow-emerald-900/10 transition-all duration-200">
              <div className="flex items-center justify-between mb-2">
                ...
                {isOverBudget && (
                  <span className="inline-flex items-center px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full text-xs font-medium bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 border border-red-200 dark:border-red-800/50 flex-shrink-0">
                    Over Budget
                  </span>
                )}
              </div>
              ...
              <div className="flex items-baseline gap-2 mb-3">
                <span className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white truncate">
                  {formatCurrencyWithSymbol(budget.spent, userPreferences.currency)}
                </span>
                <span className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 flex-shrink-0">
                  / {formatCurrencyWithSymbol(budget.budget, userPreferences.currency)}
                </span>
              </div>
              ...
              <div className="mb-3">
                ...
                <div className="h-2.5 rounded-full bg-gray-200 dark:bg-gray-700/50 overflow-hidden shadow-inner">
                  <div 
                    className={`h-2.5 rounded-full ${progressColor} transition-all duration-500 ease-out shadow-sm`}
              ...
              <div className="flex flex-col gap-3 pt-3 border-t border-gray-100 dark:border-gray-700">
                ...
                <div className="flex items-center gap-2">
                  <button 
                    ...
                    className="flex-1 px-3 py-1.5 text-xs sm:text-sm text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 rounded-md font-medium transition-colors"
                    title="Edit budget"
                  >
                    Edit
                  </button>
                  <button 
                    ...
                    className="flex-1 px-3 py-1.5 text-xs sm:text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md font-medium transition-colors"
                    title="Delete budget"
                  >
                    Delete
                  </button>
        ...
        <div className="space-y-5">
          <div>
            ...
            <input
              ...
              className={`block w-full rounded-lg border px-4 py-2.5 text-sm shadow-sm placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 transition-colors dark:bg-gray-700 dark:text-white ${
                formErrors.category
                  ? 'border-red-300 dark:border-red-500/50 focus:ring-red-500 focus:border-red-500 bg-red-50/50 dark:bg-red-900/10'
                  : 'border-gray-300 dark:border-gray-600 focus:ring-emerald-500 focus:border-emerald-500 hover:border-gray-400 dark:hover:border-gray-500'
              }`}
          ...
          <div>
            <label htmlFor="budgetAmount" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
              Budget Amount *
            </label>
            <div className="relative">
              ...
              <input
                ...
                className={`block w-full pl-8 pr-4 py-2.5 border rounded-lg shadow-sm placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 transition-colors dark:bg-gray-700 dark:text-white text-sm ${
                  formErrors.amount
                    ? 'border-red-300 dark:border-red-500/50 focus:ring-red-500 focus:border-red-500 bg-red-50/50 dark:bg-red-900/10'
                    : 'border-gray-300 dark:border-gray-600 focus:ring-emerald-500 focus:border-emerald-500 hover:border-gray-400 dark:hover:border-gray-500'
                }`}
          ...
          <div className="flex flex-col-reverse sm:flex-row justify-end gap-2 sm:gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <button
              ...
              className="w-full sm:w-auto px-4 py-2 text-sm font-medium text-white bg-emerald-600 dark:bg-emerald-600 rounded-md shadow-sm hover:bg-emerald-700 dark:hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition-colors"
            >
